            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#1a1a25] border border-white/8 rounded-lg pl-9 pr-4 py-2.5 text-sm font-ui text-[#f2eef8] placeholder-[#5a5670] outline-none focus:border-[#bb86fc]/50 focus:bg-[#1a1a25] transition-colors"
                />
              </div>
            </div>
